...
###################
## Variation partitioning of community composition data table using RDA

# a) generate PCNM spatial eigenfunctions to represent spatial structure across spatial scales
mite.spadist <- dist(mite.xy)
mite.PCNM.auto <- PCNM(mite.spadist)

# number of eigenvalus
